...
class PayPal_Gateway_Addon extends E20R_PW_Gateway_Addon {
	...
	public function update_credit_card_info( User_Data $user_data, $card_data, $gateway_name ) {
		...
		// TODO: Implement PayPal specific fetch of Credit card data
	}
	...
	public function get_gateway_subscriptions( User_Data $user_data ) {
		...
		// TODO: Implement get_gateway_subscriptions() method for PayPal
	...
	private function load_defaults() {
		...
		return array(
			...
			'paypal_sandbox_account'       => 'christine-facilitator@wickedstrongchicks.com',
			'paypal_sandbox_client_id'     => 'ASSfzFzrKsbjafx1LlgVhrK-PNs2omDRP-WEf_0F8ecKHGziUnIXCSk7TwkNOqRNrN_8Szo8SF5SI8DZ',
			'paypal_sandbox_secret'        => 'EHHv_ahqMFHsL9AjO7m2JPhXtoLgrBTDZF1YLlxRQmn5XHVocSdTBvnGEMpDZdPewlxAhk1KUfx1ztvL',
			'paypal_sandbox_token'         => null,
			'paypal_sandbox_token_expires' => null,
			'paypal_account'               => 'christine@wickedstrongchicks.com',
			'paypal_client_id'             => 'ASfdt6-rLnek7w7TETDP1lxhuXyqgndmALEd23DPVsqaW9qSiAwdjyn4qHtdPIvOi4gPMRiGFJLzmQSV',
			'paypal_client_secret'         => 'ELxJHsB7pkllSfDIqL2DtxmE5D3R8zbiiE0ie6WDVaci46h8fDKvc0MsrXuljJ1ItYn7vM11XjURbsRB',
			'paypal_token'                 => null,
